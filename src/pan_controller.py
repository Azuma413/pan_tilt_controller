...
def sendRoverTwist():
    rover_data = Twist()
    rover_data.linear = [0.0, 0.0, 0.0]
    rover_data.angular = [0.0, 0.0, 0.0]
    rover_data.linear[1] = target_pos["pan"] * speed
    rover_data.angular[2] = target_pos["tilt"]
...
if __name__ == "__main__":
    ...
    pub2 = rospy.Publisher("/hogehoge", Twist, queue_size=1)
